...
namespace WebApp.Repositories.PatientRepositories
{
    public class PatientRepository : IRepository<Patient>
    {
        ...
        //Felix
        public List<Doctor> GetDoctorByPatent()
        {
            string P_name = "";
                

                var response = ApiConsumerHelper.GetResponseString("api/DoctorByPatient?P_name"+ P_name);
                var result = JsonConvert.DeserializeObject<List<Doctor>>(response);
            return result;
        }
